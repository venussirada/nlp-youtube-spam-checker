...
############################################################
df = pd.read_csv('Youtube01-Psy.csv', encoding='utf-8')
...
# Further more, we print out all the emoticons using regex (only unicode emojis, doesn't include ASCII emoticons or non-unicode emojis like ♡, :D, ❤️ etc.)
...
# We may need to pre-process by remvoing  stop words and punctuation, converting all text to lowercase or uppercase 
...
# 42 true positive predictions (TP)
# 2 false positive prediction (FP)
# 3 false negative prediction (FN)
# 41 true negative predictions (TN)
...
new_comments = [
    ...
    # "He is a good singer",
    # "He is a good dancer",
    # "The direction of this music video is good",
    # "oh my god, there are 10 billion views",
    # "send me money",
